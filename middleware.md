...
| 0:45 | 0:20 | Hands-on I |
| 1:05 | 0:10 | BREAK |
| 1:15 | 0:30 | Hands-on II |
| 1:45 | 0:10 | Lab Time |
| 1:55 | 0:05 | Wrap Up |
| **TOTAL** | **2:00** | |
...
### 5. IP reality check — fuel for Hands-on II (~10m)
...
> “Hands-on I: get the hallway compiling — Recover, RequestID, one custom header middleware, `/whoami` printing RealIP. Hands-on II: decide inside/outside and name the traps. Lab: harden one sharp edge. Break in twenty.”

---

## Hands-on I (20 min) — Hallway MVP
...
Blocked by:
Next: Hands-on II inside-the-building decision
```
...
**≤2m next when back:** open Hands-on II; don’t invent a new repo.

---

## Hands-on II (30 min) — Inside the Building
...
1. Keep Hands-on I’s module. Set `e.IPExtractor = echo.ExtractIPDirect()`.  
